...
@Author  : -
@Time    : 2025/3/8 23:24
@File    : dataloader4ml100kIndexs.py
@Description : 
"""
import os
import sys
...
from recommend_code.Logistic_Regression.dataloader4ml100kOneHot import occupation_path
...
def generate_user_df():
    ...
    begin += 2
    occupations_dict, begin = __read_occupation_index(begin)
    uids = []
    all_users = []
    ...
    with open(user_path, 'r') as f:
        for line in f.readlines():
            ...
            user_indexs.append(occupations_dict[d[3]])
